  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row items-center justify-start gap-[10px]">
        <button
          className="btnuserclick [border:none] py-2.5 px-2 bg-white-8 w-40 rounded-xl flex flex-row items-center justify-center box-border"
        ...
        <button
          className="btnuserclick [border:none] py-2.5 px-2 bg-primary-500 w-40 rounded-xl flex flex-row items-center justify-center box-border"
          onClick={() => navigate("/")}
        >
          <div className="relative text-base leading-[24px] font-semibold font-button-2-regular text-neutral-100 text-center">
            Logout
